...
const GAS_FOR_RESOLVE_TRANSFER: Gas = TGAS.mul(5);
const GAS_FOR_FT_TRANSFER_CALL: Gas = TGAS.mul(25);
...
#[near_bindgen]
impl FungibleTokenCore for FishaToken {
    #[payable]
...
#[near_bindgen]
impl FungibleTokenResolver for FishaToken {
...
#[near_bindgen]
impl FungibleTokenMetadataProvider for FishaToken {
